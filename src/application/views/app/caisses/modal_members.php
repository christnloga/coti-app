<!-- Modal -->
<div class="modal fade" id="showMembersModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="nav-item dropdown">
                                                <?php echo form_open_multipart('Caisses/add_member'); ?>
                                                <input type="hidden" name="caisse_id" value="<?php echo $caisse['id']; ?>" class="form-control validate">
                                                <input type="hidden" name="member_id" value="<?php echo $user['id']; ?>" class="form-control validate">
                                                <button href="#" class="dropdown-item text-blue delete_member" id="<?php echo $user['id']; ?>">
