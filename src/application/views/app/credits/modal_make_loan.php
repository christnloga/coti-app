<!--Modal: modalMakeLoan-->
<div class="modal fade pt-5" id="modalMakeLoan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-notify" role="document">
        <!--Content-->
        <div class="modal-content px-4 pt-3">
            <?php echo form_open_multipart('Credits/record_loan'); ?>
            <!--Body-->
            <input type="hidden" value="<?php echo $wallet['sold']; ?>" id="sold" name="sold">
            <div class="md-form mb-3 mt-2">
                <label class="font-weight-bold" for="form34">Montant du prêt</label>
